...
export class StartListeningToCommentsResponse {
    /**
    ...
    */
    'accounts': Array<StartListeningToCommentsAccountDetailsResponse>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "accounts",
            "baseName": "accounts",
            "type": "Array<StartListeningToCommentsAccountDetailsResponse>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return StartListeningToCommentsResponse.attributeTypeMap;
    }
