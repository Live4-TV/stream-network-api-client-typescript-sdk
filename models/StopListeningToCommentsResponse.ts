...
export class StopListeningToCommentsResponse {
    /**
    ...
    */
    'accounts': Array<StopListeningToCommentsAccountDetailsResponse>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "accounts",
            "baseName": "accounts",
            "type": "Array<StopListeningToCommentsAccountDetailsResponse>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return StopListeningToCommentsResponse.attributeTypeMap;
    }
