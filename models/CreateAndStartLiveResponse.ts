...
export class CreateAndStartLiveResponse {
    /**
    ...
    */
    'accounts': Array<CreateAndStartLiveAccountDetailsResponse>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "accounts",
            "baseName": "accounts",
            "type": "Array<CreateAndStartLiveAccountDetailsResponse>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CreateAndStartLiveResponse.attributeTypeMap;
    }
